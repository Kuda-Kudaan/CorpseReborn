...
import org.golde.bukkit.corpsereborn.nms.nmsclasses.packetlisteners.PcktIn_v1_14_R1;
...
//import net.minecraft.server.v1_14_R1.PacketPlayOutBed;
...
public class NMSCorpses_v1_14_R1 extends NmsBase implements Corpses {

	private List<CorpseData> corpses;

	public NMSCorpses_v1_14_R1() {
...
//				dwField.set(entityPlayer, playerDW);
	...
	public void registerPacketListener(Player p) {
		PcktIn_v1_14_R1.registerListener(p);
	}
