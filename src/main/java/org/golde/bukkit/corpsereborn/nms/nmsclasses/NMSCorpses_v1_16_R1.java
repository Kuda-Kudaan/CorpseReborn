...
import org.golde.bukkit.corpsereborn.nms.nmsclasses.packetlisteners.PcktIn_v1_16_R1;
...
public class NMSCorpses_v1_16_R1 extends NmsBase implements Corpses {

	private List<CorpseData> corpses;

	public NMSCorpses_v1_16_R1() {
	...
	public static DataWatcher clonePlayerDatawatcher(GameProfile gp, World world,
			int currentEntId) {
		EntityHuman h = new EntityHuman(((CraftWorld) world).getHandle(), new BlockPosition(0, 0, 0),gp) {
			public void sendMessage(IChatBaseComponent arg0) {
				return;
			}
...
//				dwField.set(entityPlayer, playerDW);
	...
	public void registerPacketListener(Player p) {
		PcktIn_v1_16_R1.registerListener(p);
	}
